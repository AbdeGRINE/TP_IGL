...
@Component({
  selector: 'app-patient-afficher-consultation',
  imports: [HeaderComponent, CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './patient-afficher-consultation.component.html',
  styleUrl: './patient-afficher-consultation.component.css'
})
export class PatientAfficherConsultationComponent implements OnInit{
  ResultatBilan1 = {
    glycemie: 0,
    cholestrol: 0,
  }
