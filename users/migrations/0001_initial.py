# Generated by Django 5.1.4 on 2024-12-14 20:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.consultation')),
                ('redigant_laborantin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.laborantin')),
                ('redigant_radiologue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.radiologue')),
            ],
        ),
        migrations.CreateModel(
            name='Resume',
